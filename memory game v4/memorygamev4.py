...
class TkPygame:
    ...
    def make_tk_widgets(self):
        ...
        self.easy = tk.Button(self.tk_root, text='Easy', command=lambda: self.change_difficulty(1))
        self.easy.pack()

        self.hard = tk.Button(self.tk_root, text='Hard', command=lambda: self.change_difficulty(2))
        self.hard.pack()
